...
def format_translation(trans):
    ...
    # 先按词性标记分割，保留分隔符
    # 使用正向前瞻和正向后瞻来保留分隔符
    pattern = r'(?<=[a-zA-Z])\s+(adj\.|v\.|n\.|adv\.|prep\.|conj\.|int\.|pron\.|det\.|num\.|art\.|aux\.|modal\.|part\.|inf\.|ger\.|past\.|pp\.|pres\.|3rd\.|pl\.|sing\.|abbr\.|symb\.|prefix\.|suffix\.|comb\.|form\.|【名】|【形】|【动】|【副】|【介】|【连】|【叹】|【代】|【数】|【冠】|【助】|【情】|【分】|【不定】|【动名】|【过去】|【过去分】|【现在】|【第三人称】|【复数】|【单数】|【缩写】|【符号】|【前缀】|【后缀】|【组合】|【形式】)'
